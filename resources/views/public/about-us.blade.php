    ...
    <section class="bg-gray-50 py-20 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <!-- Visual Element -->
                <div class="relative">
                    <div class="bg-white rounded-3xl p-12 border border-gray-200 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto font-montserrat">
                    Los principios que guían cada decisión, cada diseño y cada interacción con nuestra comunidad
                </p>
            </div>

            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Autenticidad -->
                <div class="group bg-gray-50 rounded-3xl p-8 border border-gray-200 hover:border-gray-300 transition-all duration-300">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <button class="bg-black hover:bg-gray-800 text-white px-10 py-4 rounded-xl font-semibold font-montserrat uppercase tracking-wide transition-all duration-300 shadow-lg hover:shadow-xl">
                        Explorar Colección
                    </button>
                    <button class="border-2 border-gray-600 text-gray-700 hover:bg-gray-600 hover:text-white px-10 py-4 rounded-xl font-semibold font-montserrat uppercase tracking-wide transition-all duration-300 shadow-md hover:shadow-lg">
                        Síguenos en Redes
                    </button>
                </div>
            </div>
